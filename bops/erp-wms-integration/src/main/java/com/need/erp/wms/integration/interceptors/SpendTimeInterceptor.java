package com.need.erp.wms.integration.interceptors;
...
public class SpendTimeInterceptor extends HandlerInterceptorAdapter{
	...
	private static final Logger logger=Logger.getLogger(SpendTimeInterceptor.class);
	...
	*/ 
	...
	public void afterCompletion(HttpServletRequest request,
		...
		logger.info("用时："+(System.currentTimeMillis()-spendTime)+"ms");
