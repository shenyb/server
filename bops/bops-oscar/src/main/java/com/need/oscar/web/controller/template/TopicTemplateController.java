	package com.need.oscar.web.controller.template;
...
public class TopicTemplateController {
    ...
    public Message saveTopicTemplate(@RequestBody TemplateParamVO templateParamVO,Model model,HttpServletRequest request) {
		...
		String visitUrl=templateParamVO.getVisitUrl();
		if(null != visitUrl){
			String[] arrayList=visitUrl.split("/");
			String newFileName=arrayList[arrayList.length-2]+"/"+arrayList[arrayList.length-1];
