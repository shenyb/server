...
public class BopsKolAddParamVO  implements Serializable{

	/** 
	* @Fields serialVersionUID : TODO
	*/ 
	private static final long serialVersionUID = 4142699910274564264L;
    ...
    @Length(min=4,max=42,message="行家简介支持4-42个字以内")
	...
	public String toString() {
		return "BopsKolParamVO [kolId=" + kolId + ", mobile=" + mobile + ", nickName=" + nickName + ", profilePicKey="
				...
				+ ", auditorStatus=" + auditorStatus + ", memo=" + memo + "]";
	}
