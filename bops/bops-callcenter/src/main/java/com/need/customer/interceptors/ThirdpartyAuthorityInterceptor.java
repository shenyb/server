 ...
 */
public class ThirdpartyAuthorityInterceptor implements HandlerInterceptor {
	
	private static final Logger logger=Logger.getLogger(ThirdpartyAuthorityInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        logger.info("ThirdpartyAuthorityInterceptor  requestUrl :"+requestUrl);
