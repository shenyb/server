...
public class ConstantsProConfig {
	...
	public String toString() {
		return "ConstantsProConfig [userName=" + userName + ", userPwd="
				+ userPwd + ", fileUploadPath=" + fileUploadPath
				+ ", goodsUploadPath=" + goodsUploadPath + ", sceneUploadPath="
				+ sceneUploadPath + ", topicUploadPath=" + topicUploadPath
				+ ", uploadFileMaxSize=" + uploadFileMaxSize + ", pic_domain="
				+ pic_domain + ", waitPayToTradeClose=" + waitPayToTradeClose
				+ ", waitReceiveToTradeSuccess=" + waitReceiveToTradeSuccess
				+ ", uploadShareUrl=" + uploadShareUrl
				+ ", templateUploadParam=" + templateUploadParam
				+ ", templateReturnResult=" + templateReturnResult
				+ ", cookisDomain=" + cookisDomain + ", httpsSupport="
				+ httpsSupport + "]";
	}
