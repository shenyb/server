package com.need.customer.web.controller.session;
...
import com.need.customer.constant.UrlMappings;
...
public class SessionManagerController {
	...
	public String createSession( UserInfoVO userInfo,HttpServletResponse response,HttpServletRequest request,Model model) {
		...
		if(flag){
			...
			if(StringUtils.isEmpty(return_url)){
				...
				return "redirect:"+return_url;//返回登录之前
			}
	...
	/**
	 * 
	 * @author peiboli 2015年10月19日 下午4:03:28
	 * @Method: destroySession_GET 
	...
	public String toLogin(String message,String return_url ,Model model) {
		logger.info("toLogin in.. message"+message+"return_url :"+return_url);
	...
	@RequestMapping(method=RequestMethod.GET,value="/toExit")
	public String toExitPage(String message, Model model) {
		
		
		
		return ViewMappings.WEB_EXIT_PAGEE;
	}
