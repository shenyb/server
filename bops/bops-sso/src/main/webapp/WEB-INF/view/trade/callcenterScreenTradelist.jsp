								...
								<div class="row">
									<div class="col-sm-12">
										<header class="panel-heading ">
											来电号码：${page.originCallNo}${page.custNo}
										</header>
										<div
											...
											<div class="tbl-head">
												<form action="/trade/callcenter/page" method="get">
													<input type="text" id="userTradeNo" name="userTradeNo"
														value="${page.userTradeNo}" placeholder="订单号">
														<input type="text" name="originCallNo"
														value="${page.originCallNo}${page.custNo}"  style="display:none;">
														 <input
	...
	<script type="text/javascript">
		$('#light-pagination').pagination({
			...
			onPageClick : function(pageNumber, event) {
				if("${page.originCallNo}" !=null && "${page.originCallNo}" !=''){
					window.location.href = 'screen?page=' + pageNumber+'&originCallNo=${page.originCallNo}';	
				}
				if("${page.custNo}" !=null && "${page.custNo}" !=''){
					window.location.href = 'screen?page=' + pageNumber+'&custNo=${page.custNo}';	
				}
			}
		});
		function search() { 
