...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/resources/css/modal.css" >
         <link rel="stylesheet" href="/resources/css/topiclist.css" >
        <!-- 分页插件 css 样式 -->
        ...
        <section class="layout-wrap">
	        ...
	        <div class="info">
                ...
                <div class="tabbox">
                	<ul class="tablist">
	               		<div>运营位位置</div>                		
	               		<li><a href="/opsPosition/page?opsType=START_BANNER">欢迎运营位</a>
							<i class="fa fa-plus-square" title="在此位置新增运营位" opsType="START_BANNER"></i>
	               		</li>
	               		<li><a href="/opsPosition/page?opsType=HOME_BANNER">首页运营位
	               				<span>(1.4版本之前)</span></a>
							<i class="fa fa-plus-square" title="在此位置新增运营位" opsType="HOME_BANNER"></i>
	               		</li>
	               		<li><a href="/opsPosition/page?opsType=SHIJIAN_BANNER">世间-世间-BANNER</a>
							<i class="fa fa-plus-square" title="在此位置新增运营位" opsType="SHIJIAN_BANNER"></i>
	               		</li>
	               		<li><a href="/opsPosition/page?opsType=SHIJIAN_SCROLL">世间-世间-SCROLL</a>
							<i class="fa fa-plus-square" title="在此位置新增运营位" opsType="SHIJIAN_SCROLL"></i>
	               		</li>
	               		<li><a href="/opsPosition/page?opsType=KOLCATEGORY">世间-行家</a>
							<i class="fa fa-plus-square" title="在此位置新增运营位" opsType="KOLCATEGORY"></i>
	               		</li>
	               		<li><a href="/opsPosition/page?opsType=XINHUAN_BANNER">商城-banner</a>
							<i class="fa fa-plus-square" title="在此位置新增运营位" opsType="XINHUAN_BANNER"></i>
	               		</li>
	               		<li><a href="/opsPosition/page?opsType=XINHUAN_SCROLL">商城-品类运营位</a>
							<i class="fa fa-plus-square" title="在此位置新增运营位" opsType="XINHUAN_SCROLL"></i>
	               		</li>
	               		<li><a href="/opsPosition/page?opsType=XINHUAN_PREFECTURE">商城-特价专区</a>
							<i class="fa fa-plus-square" title="在此位置新增运营位" opsType="XINHUAN_PREFECTURE"></i>
	               		</li>
	               		
	               		<li><a href="/opsPosition/page?opsType=XINHUAN">商品-新欢</a>
							<i class="fa fa-plus-square" title="在此位置新增运营位" opsType="XINHUAN"></i>
	               		</li>
	               	</ul>
					<div class="tabview">
						<div class="tabview-table">
				                	...
				                	<td>${ops.opsName}</td>
				                     ...
				                     <td>
			                            ...
			                            <c:choose>
			                              ...
			                              <c:when test="${ops.opsType=='XINHUAN_SCROLL'}">
			                                | <a  href="/opsXinhuanGoods/xinhuanGoods?opsId=${ops.opsId}" id="allocationOps" >分配商品(1.4)</a>
			                                | <a  href="javascript:;" id="allocationOps" onclick="ballAllocation('${ops.opsId}','${ops.opsType}')">分配专题(2.0)</a>
			                              </c:when>
			                              <c:otherwise>
				    ...
				    <form class="form-horizontal" action="/topic/category" method="post">
				    	<fieldset>
	                        ...
	                        <div class="control-group">
	                              ...
	                              <div class="controls col-lg-5">	                                
	                              	 <select class="form-control" name="opsType" id="addOpsType" disabled="disabled">
	    									<option value="START_BANNER">欢迎运营位</option>
	    									<option value="HOME_BANNER">首页运营位</option>
	    									<option value="SHIJIAN_BANNER">世间-世间-BANNER</option>
	    									<option value="SHIJIAN_SCROLL">世间-世间-SCROLL</option>
	    									<option value="XINHUAN">商品-新欢(1.2)</option>
	    									<option value="XINHUAN_BANNER">商城-BANNER(1.3)</option>
	    									<option value="XINHUAN_SCROLL">商城-品类运营位(1.3)</option>
	    									<option value="XINHUAN_PREFECTURE">商城-特价专区(1.3)</option>
	    									<option value="KOLCATEGORY">世间-行家</option>
	    								 </select>
	                              </div>
	                              <div style="clear: both;"></div>
	                        </div>
	...
	<div class="modal fade" id="allocationModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <script type="text/javascript">
           ...
           $(".fa.fa-plus-square").click(function(){
        	   $('#addOpsName').val('');
        	   $('#addOpsType').val($(this).attr("opsType"));
        	   $('#addOpsPic').val('');
        	   $('#imgDiv').hide();
        	   $('#mainpic').attr("value","");
        	   $('#addOpsId').val('');
