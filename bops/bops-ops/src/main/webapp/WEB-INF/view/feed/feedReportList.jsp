...
<html>
    ...
    <body>
                            ...
                            <div class="con">
                                <div class="page-head">				           
                                    <div class="state-information">
                                        <ol class="breadcrumb m-b-less bg-less">
                                            ...
                                            <li class="active">feed未处理举报管理</li>
                                        </ol>
                                    </div>
                                </div>
                                ...
                                <div class="info">
                                    ...
                                    <div class="search-form">
                                        <form class="form-inline" action="/user/feed/report/page" method="get">
                                            <div class="row">
                                        ...
                                        <tbody>
                                            <c:forEach items="${list}" var="feed" varStatus="status">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="javascript:void(0);" onclick="freezeUser('./freezeReport/${feed.feedReportId}/${feed.userId}', '${feed.nickName}')">禁止登陆</a>
                                                        <a href="javascript:void(0);" onclick="ignore('./ignoreReport/${feed.feedReportId}')">暂不处理</a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
        ...
        <script type="text/javascript">
            ...
            function ignore(url) {
                $.messager.confirm("不作处理", "您确定要不做处理？", function () {
                    $.ajax({
                        type: "PUT",
                        url: url,
                        dataType: "json",
