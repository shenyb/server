				        ...
				        <div class="info">
				            <div class="info-top">
				                ...
				                <div class="back">
				                    ...
				                    <a class="bops-pub-btn button button-rounded button-tiny" href="javascript:;"  data-toggle="modal" data-target="#myModal3"  onclick="addUser()">新增用户</a>			                   
				                </div>
				            </div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-horizontal ng-pristine ng-valid">
				    	<fieldset>
					    	<div class="control-group">
	                              ...
	                              <label class="control-label col-lg-4" for="">登陆名</label>                              
	                              <div class="controls col-lg-5">	                                
	                              	 <input id="userName2"  type="text"  class="form-control">
	                              </div>
	                              <div style="clear: both;"></div>
	                        </div>
	                        <div class="control-group">
	                              ...
	                              <label class="control-label col-lg-4" for="">用户姓名</label>                              
	                              <div class="controls col-lg-5">	                                
	                              	  <input id="userRealName2" type="text"  class="form-control">
	                              </div>
	                              <div style="clear: both;"></div>
	                        </div>
	                        <div class="control-group">
	                              <!-- Text input-->
	                              <label class="control-label col-lg-4" for="">初始密码</label>                              
	                              <div class="controls col-lg-5">	                                
	                              	  <input id="password2" type="password" ng-model="addData.userPwd" class="form-control">
	                              </div>
	                              <div style="clear: both;"></div>
	                        </div>
							 <div class="control-group">
	                              ...
	                              <label class="control-label col-lg-4" for="">手机号</label>                              
	                              <div class="controls col-lg-5">	                                
	                              	  <input id="userMobile2"  type="text"  class="form-control">
	                              </div>
	                              <div style="clear: both;"></div>
	                        </div>
	                         <div class="control-group">
	                              ...
	                              <label class="control-label col-lg-4" for="">工作邮箱</label>                              
	                              <div class="controls col-lg-5">	                                
	                              	  <input id="userEmail2" type="text"  class="form-control">
	                              </div>
	                              <div style="clear: both;"></div>
	                        </div>
	                         <div class="control-group">
	                              ...
	                              <label class="control-label col-lg-4" for="">所属部门</label>                              
	                              <div class="controls col-lg-5">	                                
	                              	 <select id="userDept2"  class="form-control">
		                                <option value="财务部">财务部</option>
		                                <option value="人事行政部">人事行政部</option>
		                                <option value="产品技术部">产品技术部</option>
		                                <option value="平台运营部">平台运营部</option>
         ...
         <%-- <form class="ng-pristine ng-valid">
			...
			<div class="modal-footer">
				<button type="button" class="button button-capitalize button-rounded button-primary button-small" data-dismiss="modal" onclick="submit_add()">确定</button>
				<button type="button"  class="button button-capitalize button-rounded button-primary button-small" data-dismiss="modal">取消</button>
			</div>
			</form>
			</div>
