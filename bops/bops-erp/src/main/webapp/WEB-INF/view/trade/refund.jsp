				...
				<div class="layout-right-bottom">
					...
					<div class="form-page-wrap">
						<div class="data-page-inner">
							<div class="page-head">
								<h3 class="m-b-less">退款</h3>								
								<div class="back">																
								 	<a class="button button-primary button-raised button-small" href="javascript:javascript:window.history.back(-1);">返回</a>
								 	<a class="button button-primary button-raised button-small" href="javascript:javascript:window.location.reload();">刷新</a>
								</div>
							...
							<div class="wrapper">
								<div class="row">
									<div class="col-sm-12">
										<form id="tradeRefundForm" action="/trade/refund"
												...
												<div class="panel-body">
													<div class="form-horizontal">
														<div class="form-group">
															...
															<div class="col-lg-9">
																<input type="hidden" name="tradeNo"
																	value="${trade.tradeNo}"> ${trade.tradeNo}
															</div>
														</div>
														<div class="form-group">
														...
														<div class="form-group smallgroup">
															...
															<div class="col-lg-9">
																<input type="text" name="refundAmount" class="form-control">
															</div>
														</div>
														<div class="form-group">
														...
														<div class="form-group">
															...
															<div class="col-lg-9">
																<textarea rows="3" cols="50" name="memo" class="form-control"></textarea>
															</div>
														</div>
														<input type="button" onclick="refund();" class="button button-primary button-raised button-small pull-right" value="确定">
													</div>
												</div>
											</section>
