					...
					<div class="data-page-wrap">
				        ...
				        <div class="info">
				            <div class="info-top">
				                <span>交易列表</span>
				                <div class="back">
				                    <a href="/trade/toExportPage" class="button button-primary button-raised button-small">导出订单</a>
				                   <a href="/trade/toBatchPage" class="button button-primary button-raised button-small">批量发货</a>
				                </div>
				            </div>
				            <div class="search-form">
				            <form method="get" action="/trade/page" class="form-inline">
								<div class="row">
									<div class="form-group col-xs-3">
				                        <label for="tradeTimeStart">交易开始时间</label>
											...
											<div class="tbl-head">
												<form action="/trade/page" method="get">
													<input type="text" id="mobile" name="mobile"
														value="${page.mobile}" placeholder="买家手机号"><input
