...
<body>
						...
						<div class="data-page-inner">
							...
							<div class="wrapper">
								<div class="row">
									<div class="col-sm-12">
										<section class="panel">
											<header class="panel-heading">商品库存导出</header>
											<form id="form_store_export_data"	>
											<div class="panel-body">
												<div class="form-horizontal">
													<div class="form-group">
														...
														<div class="col-lg-9">
															<label for="label_SELF_WAREHOUSE"> <input checked="checked"
																...
																name="warehouseType" value="SELF_WAREHOUSE"> 北京仓
															</label>
															...
															<label for="label_OVERSEA_WAREHOUSE"> <input checked="checked"
																...
																name="warehouseType" value="OVERSEA_WAREHOUSE"> 香港仓
															</label>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-lg-9">
															<a class="button button-primary button-raised button-small pull-left" href="javascript:void(0);"
																onclick="daochuStore();"> 导出库存</a>
														</div>
													</div>
												</div>
											</div>
	...
	<script type="text/javascript">
		...
		function daochuStore(){
			var param = $("#form_store_export_data").serializeArray();
			console.info(param);
			...
			url = url + "warehouseType=" + exportParam_warehouseType
