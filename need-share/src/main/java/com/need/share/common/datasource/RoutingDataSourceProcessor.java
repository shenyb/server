package com.need.share.common.datasource;
...
import com.need.share.common.datasource.RoutingDataSourceCommon.DBTypeEnum;


/**
 * 
 * 类RoutingDataSourceProcessor.java的实现描述：TODO datasource路由， 
 * @author lijie 2014年11月25日 下午5:43:20
 */
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        try {
            ...
            for(Entry<String, TransactionAttribute> entry : nameMap.entrySet()) {
                ...
                logger.debug("read/write transaction process  method:{}", methodName);
