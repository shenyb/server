...
public class HttpUtils  {
	 ...
	 */
	// public static Map<String, String> getParameters(HttpServletRequest
	// request) {
    ...
    /**
     * @author Rylan 2015年7月30日 下午5:57:13
     * @Method: resolveMultipartRequest 
     * @Description: TODO  
    ...
    /**
     * @author Rylan 2015年7月30日 下午5:56:11
	...
	/**
	 * 发送给支付宝，微信回调的消息
	 * @author shenyb 2015年8月29日 下午4:05:25 @Method: sendToCFT @Description:
	 *         @param msg @throws IOException @throws
	 */
	public static void sendToResponse(HttpServletResponse response, String msg) throws IOException {
		PrintWriter out = response.getWriter();
		out.println(msg);
		out.flush();
		out.close();
