...
import com.need.schedule.zk.ZKTools;
...
public class ZookeeperTest {
	...
	public void testPrint() throws Exception {
		ZooKeeper zk = new ZooKeeper("101.200.182.96:2181", 3000, null);
		StringWriter writer = new StringWriter();
	...
	public void testCreateTask() throws Exception {
		...
		zk.addAuthInfo("digest", "ScheduleAdmin:password".getBytes());
		acls.add(new ACL(ZooDefs.Perms.ALL, new Id("digest",DigestAuthenticationProvider.generateDigest("ScheduleAdmin:password"))));
