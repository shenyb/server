...
public class GoodsStoreDetailVO implements Serializable {
	...
	private String updateOnlineName;
	...
	public String getUpdateOnlineName() {
		return updateOnlineName;
	}

	public void setUpdateOnlineName(String updateOnlineName) {
		this.updateOnlineName = updateOnlineName;
	}
