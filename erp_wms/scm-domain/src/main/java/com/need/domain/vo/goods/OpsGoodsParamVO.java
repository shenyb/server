...
public class OpsGoodsParamVO implements Serializable {
	...
	private Integer goodsIndexCategoryOne; //商品检索分类
	...
	public Integer getGoodsIndexCategoryOne() {
		return goodsIndexCategoryOne;
	}

	public void setGoodsIndexCategoryOne(Integer goodsIndexCategoryOne) {
