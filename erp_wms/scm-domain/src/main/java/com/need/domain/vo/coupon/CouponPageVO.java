 ...
 */
public class CouponPageVO extends Page implements Serializable {
    ...
    public String toString() {
        return "CouponPageVO{" + "couponTemplateNo=" + couponTemplateNo + ", couponStatus=" + couponStatus + ", couponTemplateId=" + couponTemplateId + '}';
    }
