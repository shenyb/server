									            ...
									            <header class="panel-heading">
									                ...
									                <!--<tbody>-->							                
														...
														<tr>
									                     ...
									                     <tr>
									                         <td>最后上架人</td>
									                        <td>${goods.updateOnlineName}</td> 
									                        <td>最后上架时间</td>
									                        <td><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss"
																	value="${goods.updateOnlineTime}" type="both" /></td>                       
									                    </tr>
											...
											<tr style="display:none;">
												...
												<td colspan="3">
									             ...
									             <table class="table table-bordered table-hover table-condensed table-responsive">
									                    ...
									                    <tr>
									                    <td>${bopsGoodsSales.salesServen}</td>
									                    <td>${bopsGoodsSales.salesFifteen}</td>
									                    <td>${bopsGoodsSales.salesSixty}</td>
									                    <td>
									                    	<c:if test="${bopsInventoryVO.isHavest =='1'}">有货</c:if>
									                    	<c:if test="${bopsInventoryVO.isHavest =='2'}">无货</c:if>
									                    </td>
									                    <td>${bopsInventoryVO.normalQuantity}</td>
									                    <td>${bopsInventoryVO.saleQuantity}</td>
									                    <td>${bopsInventoryVO.orderFreeze}</td>
									                    <td>${bopsInventoryVO.otherFreeze}</td>
									                    <td>${bopsInventoryVO.demageQuantity}</td>
									                    </tr>
									              </table>
									        </div>
