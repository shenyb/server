					 ...
					 <div class="con">
					        ...
					        <div class="info">
					            <div class="info-top">
					                ...
					                <a class="button button-primary button-raised button-small" href="javascript:;" data-toggle="modal"
										data-target="#myModal3" onclick="addUser()">新增</a>
					                </div>
					            </div>
					            ...
					            <table class="table table-bordered table-hover">					
					                ...
					                <c:forEach items="${list}" var="user" varStatus="status">
											<tr>
												...
												<td style="text-align:left;">${user.userEmail}</td>
												<td>${user.userMobile}</td>
												<td>${user.userDept}</td>
												<td>
												<a href="javascript:;" data-toggle="modal" data-target="#myModal"
													onclick="showById('${user.userId}')">查看 </a>| 
												<a href="javascript:;" data-toggle="modal" data-target="#myModal2"
													onclick="fixById('${user.userId}')"> 修改</a> | 
												<a id="${user.userId}" href="javascript:;"
													onclick="deleteById('${user.userId}')">删除</a></td>
											</tr>
										</c:forEach>
					                </tbody>				            	
					            </table>
									...
									<div class="col-sm-12">
										<section class="panel">
											<header class="panel-heading ">
												用户列表 <span class="tools pull-right"> <a
													class="ops-pub-btn" href=""> <i class="fa fa-refresh"></i>
														<span>刷新</span>
												</a> <a class="bops-pub-btn ng-isolate-scope"
													href="javascript:;" data-toggle="modal"
													data-target="#myModal3" onclick="addUser()"><i
														class="fa fa-plus"></i><span>新增用户</span></a>
												</span>
											</header>
											<div
													...
													<thead>
														<tr role="row">
															<th
																...
																tabindex="0" class="sorting_asc">用户账号</th>
															<th
														...
														<c:forEach items="${list}" var="user" varStatus="status">
															<tr>
																...
																<td><a href="javascript:;" data-toggle="modal"
																	data-target="#myModal"
																	onclick="showById('${user.userId}')">查看 </a>| <a
																	href="javascript:;" data-toggle="modal"
																	data-target="#myModal2"
																	onclick="fixById('${user.userId}')"> 修改</a> | <a
																	id="${user.userId}" href="javascript:;"
																	onclick="deleteById('${user.userId}')">删除</a></td>
															</tr>
														</c:forEach>
													</tbody>
												...
												<div class="tbl-footer clearfix">
													<div class="tbl-info pull-left">
														<div aria-live="polite" role="status"
															id="DataTables_Table_0_info" class="dataTables_info">共有
															${page.total}条, 每页显示 ${page.pageSize}</div>
													</div>
													<div class="tbl-pagin pull-right">
														<div id="light-pagination"></div>
													</div>
					...
					<form class="ng-pristine ng-valid">
						<table class="bops-pub-dialog-table">
							<tbody>
								<tr>
									<th>登陆名：</th>
									<td><input id="userName1" type="text"
										class="ng-pristine ng-untouched ng-valid" disabled='disabled'>
									</td>
								</tr>
								<tr>
									<th>用户姓名：</th>
									<td><input id="userRealName1" type="text"
										class="ng-pristine ng-untouched ng-valid" disabled='disabled'>
									</td>
								</tr>
								<tr>
									<th>手机号：</th>
									<td><input id="userMobile1" type="text"
										class="ng-pristine ng-untouched ng-valid" disabled='disabled'>
									</td>
								</tr>
								<tr>
									<th>工作邮箱：</th>
									<td><input id="userEmail1" type="text"
										class="ng-pristine ng-untouched ng-valid" disabled='disabled'>
									</td>
								</tr>
								<tr>
									...
									<td>
										<div id="updateRoleList">
											<c:forEach items="${roleList}" var="role" varStatus="status">
												<!-- ngRepeat: data in roleList -->
												<label ng-repeat="data in roleList" class="ng-scope">
													<input id='check_${role.roleId}' name="check_user"
													type="checkbox" value="${role.roleId}" disabled='disabled'>
													<span class="ng-binding">${role.roleName}</span>
												</label>
												<!-- end ngRepeat: data in roleList -->
											</c:forEach>
										</div>
									</td>
								</tr>
					...
					<form class="ng-pristine ng-valid">
						<table class="bops-pub-dialog-table">
							<tbody>
								...
								<tr>
									<th>用户姓名:</th>
									<td><input id="userRealName" type="text"
										class="ng-pristine ng-untouched ng-valid"></td>
								</tr>
								<tr>
									<th>手机号:</th>
									<td><input id="userMobile" type="text"
										class="ng-pristine ng-untouched ng-valid"></td>
								</tr>
								<tr>
									<th>工作邮箱:</th>
									...
									<td>
										<div id="updateRoleList">
											<c:forEach items="${roleList}" var="role" varStatus="status">
												<!-- ngRepeat: data in roleList -->
												<label ng-repeat="data in roleList" class="ng-scope">
													<input id='edit_${role.roleId}' name="edit_user"
													type="checkbox" value="${role.roleId}"> <span
													class="ng-binding">${role.roleName}</span>
												</label>
												<!-- end ngRepeat: data in roleList -->
											</c:forEach>
										</div>
					...
					<form class="ng-pristine ng-valid">
						<table class="bops-pub-dialog-table">
							<tbody>
								<tr>
									<th>登陆名：</th>
									<td><input id="userName2" type="text"
										class="ng-pristine ng-untouched ng-valid"></td>
								</tr>
								<tr>
									<th>用户姓名：</th>
									<td><input id="userRealName2" id="userRealName2"
										type="text" class="ng-pristine ng-untouched ng-valid">
									</td>
								</tr>
								<tr>
									<th>初始密码：</th>
									<td><input id="password2" type="password"
										ng-model="addData.userPwd"
										class="ng-pristine ng-untouched ng-valid"></td>
								</tr>
								<tr>
									<th>手机号：</th>
									<td><input id="userMobile2" type="text"
										class="ng-pristine ng-untouched ng-valid"></td>
								</tr>
								<tr>
									<th>工作邮箱：</th>
									...
									<td>
										<div id="updateRoleList2">
											<c:forEach items="${roleList}" var="role" varStatus="status">
												<!-- ngRepeat: data in roleList -->
												<label ng-repeat="data in roleList" class="ng-scope">
													<input id='create_${role.roleId}' name="create_user"
													type="checkbox" value="${role.roleId}"> <span
													class="ng-binding">${role.roleName}</span>
												</label>
												<!-- end ngRepeat: data in roleList -->
