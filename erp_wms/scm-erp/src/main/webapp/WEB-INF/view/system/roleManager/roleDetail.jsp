				        ...
				        <div class="info">
				            <div class="info-top">
				                ...
				                <div class="back">
				                    ...
				                    <a href="javascript:javascript:window.location.reload();"  id="exportGoods" class="button button-primary button-raised button-small">刷新</a>
				                </div>
				            </div>
				                ...
				                <form class="form-inline">
				                    <div class="row">
					                    <div class="form-group col-xs-3">
					                        <label for="form_goodsCode">角色名称</label>
					                    ...
					                    <div class="form-group col-xs-3">
					                        <label for="form_goodsBarcode">所属部门</label>
					                        <select id="roleDept" name="roleDept" ng-model="roleData.roleDept"
												class="ng-pristine ng-untouched ng-valid form-control">
								 ...
								 <header class="panel-heading "> 
                                  ...
                                  <form class="form-horizontal">
										<!-- <div class="form-group"> -->
											<label for="" class="col-xs-1">角色名称</label>
											<div class="col-xs-2">
											<input id="roleName" name="roleName" type="text"
												placeholder="请输入角色名称" ng-model="roleData.roleName"
												class="ng-pristine ng-untouched ng-valid form-control">
										...
										<!-- </div>
										<div class="form-group"> -->
											<label for="" class="col-xs-1">所属部门</label>
											<div class="col-xs-2">
											<select id="roleDept" name="roleDept" ng-model="roleData.roleDept"
												class="ng-pristine ng-untouched ng-valid form-control">
													<option value="财务部">财务部</option>
