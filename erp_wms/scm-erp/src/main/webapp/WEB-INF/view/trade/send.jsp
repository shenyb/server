						...
						<div class="data-page-inner">
							...
							<div class="wrapper">
								<div class="row">
											...
											<div class="info">
									            ...
									            <header class="panel-heading">
													...
													<div class="back">
														...
														<a href="javascript:javascript:window.history.back(-1);" class="button button-primary button-raised button-small">返回</a>
									                ...
									                <!--<tbody>-->							                
									                    <tr>									                       
									                        ...
									                        <td>商品名称</td>
									                        <td>
									                        	<c:forEach items="${trade.goodsList}" var="goods" varStatus="status">
									                    ...
									                    <tr>									                       
									                        <td>买家收货地址</td>
									                        <td colspan="3">${trade.nickName}</td>                       									                    									                                              
									                    </tr>
									                    <tr>									                       
									                        <td>交易状态</td>
									                        <td>
																...
																<c:if
																	test='${trade.tradeStatus == "WAIT_PLATFORM_SEND"}'> 待发货 </c:if>
									                        ...
									                        <td>商品编号</td>
									                        <td>
									                        	<input type="hidden" name="goodsSnNo" value="${goods.goodsCode}" />
																	${goods.goodsCode} 
									                        </td>                       
									                    </tr>
									                    <tr>									                       
									                        <td>国际条形码</td>
									                        <td colspan="3">${goods.goodsBarcode}</td>                       									                    									                                              
									                    </tr>
														...
														<tr>
															<td>服务商</td>
															<td>
																<select id="logisticsServiceId" name="logisticsServiceId" class="form-control">
															...
															<td>物流编号</td>
															<td>
																<input name="logisticsNums"  class="form-control"/>
															</td>
														</tr>
									                   </table>
									                    <div class="form-group btnlist">
															 <input type="button" onclick="send();" class="button button-primary button-raised button-small pull-right" value="发货">
													   </div>	
									...
									<%-- 	<!-- 2222222222 -->
										<form id="tradeSendForm" action="/trade/send/${tradeNo}"
														...
														<c:forEach items="${trade.goodsList}" var="goods"
															...
															<div class="form-group">
																...
																<input type="hidden"
																	...
																	${goods.goodsCode} </span>
															 <label for="" class="col-lg-2">国际条形码</label>
																<span class="col-lg-1">${goods.goodsBarcode}</span>
																<!-- <label
