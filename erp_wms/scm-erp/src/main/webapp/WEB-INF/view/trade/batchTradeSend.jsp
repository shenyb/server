								...
								<div class="row">
									<div class="col-sm-12">
										<section class="panel">
											...
											<div class="dataTables_wrapper form-inline dt-bootstrap no-footer send-list"
												...
												<form id="batchSendContent_form">
													...
													<div class="col-lg-12" >	
														<span class="button button-primary button-raised  button-small pull-right" id="batch_trade_send_form">批量发货</span>
														<span class="button button-primary button-raised  button-small pull-right" id="batch_trade_send_template_download">批量发货模板下载</span>															
