...
public class CouponUserPO implements Serializable {
    ...
    private String tradeNo;//使用优惠券的交易编号
    ...
    public String toString() {
        return "CouponUser [couponNo=" + couponNo + ", couponTemplateId=" + couponTemplateId + ", shareUserId=" + shareUserId + 
                ...
                ", value="+ value + ", description=" + description + ", minCost=" + minCost + ", goodsId=" + goodsId + ", startTime=" + startTime + 
                ", endTime=" + endTime + ", useTime=" + useTime + ", couponStatus=" + couponStatus + ", tradeNo=" + tradeNo + ", goodsId=" + goodsId + 
