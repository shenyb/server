package com.need.common.core.thirdpartypay.alipay.util;
...
import com.need.common.core.thirdpartypay.alipay.util.httpClient.HttpProtocolHandler;
import com.need.common.core.thirdpartypay.alipay.util.httpClient.HttpRequest;
import com.need.common.core.thirdpartypay.alipay.util.httpClient.HttpResponse;
import com.need.common.core.thirdpartypay.alipay.util.httpClient.HttpResultType;
...
/*
 * * 类名：AlipaySubmit 功能：支付宝各接口请求提交类 详细：构造支付宝各接口表单HTML文本，获取远程HTTP数据 版本：3.3 日期：2012-08-13 说明： 以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己网站的需要，按照技术文档编写,并非一定要使用该代码。
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
		...
		if (AlipayConfig.sign_type.equals("MD5")) {
			mysign = MD5.sign(prestr, PropertiesUtil.getProperty("/properties/alipay.properties", "partner"),
	...
	public static String query_timestamp() throws MalformedURLException, DocumentException, IOException {
		...
		String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner="
				+ PropertiesUtil.getProperty("/properties/alipay.properties", "partner") + "&_input_charset"
				+ AlipayConfig.input_charset;
