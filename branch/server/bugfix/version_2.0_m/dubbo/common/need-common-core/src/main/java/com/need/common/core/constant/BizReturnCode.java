package com.need.common.core.constant;
...
public final class BizReturnCode {
	 ...
	 * WAP站浏览器类型不能为空
	 */
	public final static int EXPLORER_TYPE_NOT_EXIST = 15;
	/**
	 * 交易常量-------------------------------------------------------------------
	 */
	/**
	 ...
	 * 下单是购物车为空
	 */
	public static final int TRADE_CART_NULL = 7036;
	/**
	 * 分销下单时，报税仓商品数量限制为1
	 */
	public static final int TRADE_CONFIRM_ORDER_EXCEED_ERROR = 7036;

	/**
	 * 分销下单地址错误
	 */
	public static final int TRADE_CONFIRM_URL_ERROR = 7037;

	public static final int TRADE_NO_NULL = 7038;
	 ...
	 * 物流省市区对应的编号
	 */
	public static final int LOGISTICSID_NOT_NULL = 7101;
	/**
	 * 详细地址不能为空
	 */
	public static final int ADDRESS_NOT_NULL = 7102;

	/**
	 * 省市区地址不能为空
	 */
	public static final int LOGISTICS_VALUE_NOT_NULL = 7103;

	/**
	 * 收件人手机号不能为空
	 */
	public static final int TELEPHONE_NOT_NULL = 7104;

	/**
	 * 收货人姓名不能为空
	 */
	public static final int RECEIVER_NOT_NULL = 7105;
	/**
	 * CertificationCard  not null
	 */
	public static final int CERTIFICATIONCARD_NOT_NULL = 7106;
	/**
	 * 身份证正面不能为空
	 */
	public static final int CERTIFICATIONPOSITIVEKEY_NOT_NULL = 7107;
	/**
	 * CertificationNegativeKey  不能为空
	 */
	public static final int CERTIFICATIONNEGATIVEKEY_NOT_NULL = 7108;
	...
	/**
	 * 账号已被封禁，请联系tousu@welanter.com
	 */
	public final static int USER_STATUS_FREEZE = 2205;
	
	/**
	 * 用户佣金账户不存在
	 */
	public static final int USER_ACCOUNT_NOT_EXISTS = 2206;
	/**
	 * 该账号已绑定过need账号，请更换账号。
	 */
	public static final int SNS_IS_EXIST = 2207;
	/**
	 * 手机号数量超过五十。
	 */
	public static final int MOBILE_SIZE_ABOVE_FIFTY = 2208;
	
	/***
	 * 不支持EMOJN表情
	 */
	public final static int FEED_BACK_NO_SUPPORT_EMOJN = 2209;
	 ...
	 * 库存不足
	 */
	public final static int GOODS_ID_TOO_LONG = 3006;
	 ...
	 * 未购买用户才可兑换
	 */
	public final static int COUPON_EXCHANGE_NO_TRADE = 6027;
	 ...
	 * 无法删除其他人的feed
	 */
	public final static int FEED_COMMENT_DEL_NOT_SELF = 10003;

	/**
	 * 无法回复自己的评论
	 */
	public final static int FEED_COMMENT_NOT_SELF = 10004;

	/**
	 * feed标签没有内容
	 */
	public final static int FEED_LABEL_NO_CONTENT = 10005;
