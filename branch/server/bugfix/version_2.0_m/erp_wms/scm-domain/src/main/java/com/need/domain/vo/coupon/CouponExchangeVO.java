 ...
 */
public class CouponExchangeVO extends BopsCouponExchangePO implements Serializable {
    ...
    public String toString() {
        return "CouponExchangeVO{" + "couponExchangeId=" + couponExchangeId + ", couponExchangeCode=" + couponExchangeCode + 
