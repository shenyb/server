...
public class TradeBaseDetailVO {
	...
	private String fullCertificationCard;
	
	public String getFullCertificationCard() {
		return fullCertificationCard;
	}

	public void setFullCertificationCard(String fullCertificationCard) {
		this.fullCertificationCard = fullCertificationCard;
	}
