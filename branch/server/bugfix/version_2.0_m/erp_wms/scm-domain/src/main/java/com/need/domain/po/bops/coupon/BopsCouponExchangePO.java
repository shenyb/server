 ...
 */
public class BopsCouponExchangePO implements Serializable {
    
    private static final long serialVersionUID = 8107317397463217373L;
    
    protected Integer couponExchangeId;
    ...
    public String toString() {
        return "BopsCouponExchangePO{" + "couponExchangeId=" + couponExchangeId + ", couponExchangeCode=" + couponExchangeCode + 
                ", couponTemplateIds=" + couponTemplateIds + ", couponExchangeType=" + couponExchangeType + ", startTime=" + startTime + 
                ", endTime=" + endTime + ", auditStatus=" + auditStatus + ", bopsUserId=" + bopsUserId + ", createTime=" + createTime + '}';
    }
