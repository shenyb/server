...
public class InvCheckInventoryRecordVO implements java.io.Serializable{
	private static final long serialVersionUID = 1L;
	
	private Long id;
	private Long warehouseId;//库房号
	private String checkNo;
	private String superionBill;
	private Long skuId;//商品code
	private String lotNumber;
	private Long qty;//盘点数量
	...
	private Long inventoryState;//商品状态
	private String reason;//盘点原因
	private Long planQty;//计划盘点数量
	private Long realQty;//实际盘点数量
