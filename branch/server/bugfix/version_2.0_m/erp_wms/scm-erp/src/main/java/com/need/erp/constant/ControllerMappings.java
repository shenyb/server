...
public class ControllerMappings {
	 ...
	 * 商品定时任务
	 */
	public final static String GOODS_TASK = "goodsTask";
	 ...
	 * 采购单
	 */
	public final static String BOPS_PURCHASE = "purchase";
	
	/**
	 * 供应商物流商管理
	 */
	public final static String BOPS_VENDOR = "vendor";
	...
	static{
		...
		menu.put("/purchase/page_GET", 18);
		menu.put("/vendor/page_GET", 18);
		menu.put("", 13);
		...
		menu.put("/trade/toExportPage_GET", 23);
