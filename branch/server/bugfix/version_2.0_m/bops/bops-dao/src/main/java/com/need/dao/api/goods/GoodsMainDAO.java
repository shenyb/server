...
public interface GoodsMainDAO {
	...
	/**
	 * 
	 * @author peiboli 2015年12月15日 上午10:04:19
	 * @Method: updateShareStatus 
	 * @Description: TODO更新goodsMain表中分销的状态
	 * @param goodsId
	 * @param upperCase 
	 * @throws
	 */
	void updateShareStatus(@Param("goodsId")String goodsId, @Param("shareStatus")String shareStatus);
