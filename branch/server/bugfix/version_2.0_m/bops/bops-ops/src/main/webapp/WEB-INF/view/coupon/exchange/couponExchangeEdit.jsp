                                        ...
                                        <table class="table table-bordered table-hover table-condensed table-responsive">											
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" class="form-control" name="couponExchangeCode" value="${couponExchange.couponExchangeCode}" >
                                                </td>
                                                <td>优惠券兑换类型</td>
                                                <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="col-xs-5">
                                                        <b>结束时间</b>
                                                        <input type="text" id="endTimeString" name="endTimeString" class="form-control"
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2" class="large-group">
                                                    <select class="form-control" style="float:left;" name="couponTemplateId" id="couponTemplateId" value="">
                                                        <c:forEach items="${bopsCouponTemplateList}" var="item" varStatus="status">
                                                ...
                                                <td>	
                                                    <div id="saveTemplateValue" class="form-group" style="padding-left:2%;">
                                                        <c:forEach items="${templateList}" var="item" varStatus="status">
                                                            <span id="${item.couponTemplateId}" name="${item.couponTemplateId}"> ${item.couponName} <a href="#" onclick="removeThis(this)"> x</a></span>
                                                        </c:forEach> 
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-lg-9">
                                                                ...
                                                                <a class="btn btn-info" style="float:right;" href="javascript:void(0);" onClick="saveTemplate()" id="saveCouponTemplate">添加</a>
                                                                <div id="saveTemplateValue" class="form-group" style="margin-top:7%; padding-left:2%;">
                                                                        <c:forEach items="${templateList}" var="item" varStatus="status">
                                                                                                                                                <span id="${item.couponTemplateId}" name="${item.couponTemplateId}"> ${item.couponName} <a href="#" onclick="removeThis(this)"> x</a></span>
                                                                                                                                        </c:forEach> 
                                                                        </div>
