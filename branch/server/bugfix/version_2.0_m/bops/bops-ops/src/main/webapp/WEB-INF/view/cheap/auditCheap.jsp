					            ...
					            <div class="info-top">
				           		...
				           		<form  action=""   method="post"  id="cheapForm"  name="myForm" >
									...
									<tr class="table-title">
										...
										<tr>
								         	<td colspan="4">
								         	<a class="button button-primary button-raised button-small pull-right" href="javascript:;" id="valid">通过</a>
											<a class="button button-primary button-raised button-small pull-right" href="javascript:;" id="reject">拒绝</a>
								         	</td>												
										</tr>
									</table> 									
								</form>
															...
															<form  action=""   method="post"  id="cheapForm"  name="myForm" >
																...
																<table class="bops-pub-param-table">
																	...
																	<tr>
																		...
																		<td>
																		${fn:substring(cheap.cheapPrice,0,fn:length(cheap.cheapPrice)-2)}
																			元
																		</td>
																		<td style="vertical-align: top;"></td>
																	</tr>
																...
																<div class="bops-pub-param-btnlist">
																	<a class="bops-pub-btn bops-pub-param-btn" href="javascript:;" id="valid">通过</a>
																	<a class="bops-pub-btn bops-pub-param-btn" href="javascript:;" id="reject">拒绝</a>
																</div>
															</form>
														</div>	
													</div>
      ...
      /*   function save(url){
        ...
        function submitAudit(url){
            ...
            $("#valid").click(function () {
            	$.messager.confirm("审核通过", "确定审核通过!", function() { 
      	    	  $.ajax({
   	    		     type: 'POST',
   	    		     url: '/cheap/audit/'+"${cheap.cheapNo}"+"?auditStatus=VALID&goodsId="+"${cheap.goodsId}",
   	    		     dataType: 'json',
            ...
            $("#reject").click(function () {
            	$.messager.confirm("审核驳回", "确定审核驳回!", function() { 
        	    	  $.ajax({
     	    		     type: 'POST',
     	    		     url: '/cheap/audit/'+"${cheap.cheapNo}"+"?auditStatus=REJECT&goodsId="+"${cheap.goodsId}",
     	    		     dataType: 'json',
     	    		    success : function(data) {
     	    		    	window.location.href="/cheap/page";
     	   			     },
