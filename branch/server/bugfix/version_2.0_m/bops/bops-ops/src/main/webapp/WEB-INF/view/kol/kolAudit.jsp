...
<html>
    ...
    <body>
					            ...
					            <div class="info-top">
				           		...
				           		<form class="form-horizontal ng-pristine ng-valid" id="addExpertclassify" name="myForm" ng-submit="add(myForm.$valid)" novalidate="">
									<table class="table table-bordered table-hover table-condensed table-responsive">
											...
											<tr>
									            <td>用户名</td>
						                       <td class="ng-binding" id="nickname">${kol.nickName}</td>
						                        <td>用户手机号</td>
						                        <td class="ng-binding" id="form-mobile"> ${kol.mobile}</td>                 
						                    </tr>
						                    <tr>
									            <td>用户头像</td>
						                        <td colspan="2"><img id="profilePicKey" ng-src="${kol.profilePicKey}" src="${kol.profilePicKey}">	</td> 						                                          
						                   		<td><input type="text" id="form-kolId" value="${kol.kolId}"  style="visibility:hidden" ></td>
						                    </tr>
						                   
											<tr>
									            <td>行家简介</td>
						                        <td colspan="3" class="ng-binding"  id="introduct">${kol.kolIntroduct}</td>						                                          
						                    </tr>
						                    <tr>
									            <td>认证信息</td>
						                        <td colspan="3" class="ng-binding"  id="certification">${kol.certification}</td>					                                          
						                    </tr>
						                    <tr>
											<td>行家类别</td>
											<td colspan="3">
												<div id="expertclassifyList">
													...
													<span ng-repeat="expert in expertclassify" style="margin:0 10px 10px 0;" class="ng-binding ng-scope">
													 ...
													 <c:forEach items="${categorys}" var="categorys" varStatus="status">
														...
														<c:choose>
														<c:when test="${index>0}">  
														<input type="checkbox" name="kolCategoriesList" style="margin-right:5px" value="${kolCategory.categoryId}" ng-checked="expert.checked" disabled="disabled" checked="checked">
														</c:when>  
														<c:otherwise>
														<input type="checkbox" name="kolCategoriesList" style="margin-right:5px" value="${kolCategory.categoryId}" ng-checked="expert.checked" disabled="disabled">
														</c:otherwise>  
														</c:choose>
										...
										<tr>
											<td colspan="4">
												<a class="button button-primary button-raised button-small pull-right" href="javascript:;" onclick="agreeExamine()">通过</a>
												<a class="button button-primary button-raised button-small pull-right"  onclick="refuse()">拒绝</a>
											</td>
										</tr>											
									</table>																
								</form>
															...
															<form id="addExpertclassify" name="myForm" ng-submit="add(myForm.$valid)" novalidate="" class="ng-pristine ng-valid">
																...
																<table class="bops-pub-param-table">
																	...
																	<tr>
																		...
																		<td>
																			<img style="width:100px;" id="profilePicKey" ng-src="${kol.profilePicKey}" src="${kol.profilePicKey}">	
																		</td>
																		<td><input type="text" id="form-kolId" value="${kol.kolId}"  style="visibility:hidden" ></td>
																	</tr>
																	<tr>
																		<th>用户手机</th>
																		<td class="ng-binding" id="form-mobile">
																			${kol.mobile}
																		</td>
																...
																<table class="bops-pub-param-table">
																	<tbody><tr>
																		...
																		<td class="ng-binding"  id="introduct">
																			${kol.kolIntroduct}
																		</td>
																		<td style="vertical-align: top;"></td>
																	</tr>
																	<tr>
																		...
																		<td class="ng-binding"  id="certification">
																			${kol.certification}
																		</td>
																		<td style="vertical-align: top;"></td>
																	</tr>
																...
																<div class="bops-pub-param-btnlist">
																	<a class="bops-pub-btn bops-pub-param-btn" onclick="agreeExamine()">通过</a>
																	<a class="bops-pub-btn bops-pub-btn ng-isolate-scope" onclick="refuse()" style="padding: 8px 30px;">拒绝</a>
																</div>
															</form>
														</div>	
													</div>
		   ...
		   <div class="modal-dialog">
		      <div class="modal-content">
		         ...
		         <form class="form-horizontal">
				    	<fieldset>
					    	<div class="control-group">
	                              <!-- Text input-->
	                              <label class="control-label col-lg-2" for="">拒绝原因</label>                              
	                              <div class="controls col-lg-8">	                                
	                              
	    							 <textarea id="memo" cols="40" rows="5" class="form-control ng-pristine ng-untouched ng-valid"></textarea>
	                              </div>
					...
					<!-- <table class="bops-pub-dialog-table">
						<tbody><tr>
							...
							<td>
								<textarea id="memo" style="width:350px;min-height:100px" class="ng-pristine ng-untouched ng-valid"></textarea>
							</td>
						</tr>
		         ...
		         <div class="modal-footer">
		            <button type="button" class="button button-capitalize button-rounded button-primary button-small"
        ...
        function agreeExamine(){
        	...
        	var introduct= $("#introduct").text();
        	var certification= $("#certification").text();
        	$.ajax({
   		     type: 'post',
   		     data:{
   		    	kolId:kolId,
