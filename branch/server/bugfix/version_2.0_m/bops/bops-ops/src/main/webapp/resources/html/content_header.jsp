                ...
                <li>
                    <a href="javascript:;"
                       ...
                       data-toggle="dropdown">
                        <%-- <span class="notification-header-wrap">
                            <img src="http://www.huabian.com/uploadfile/2014/0910/20140910012324173.jpg" 
                    ...
                    <ul class="dropdown-menu dropdown-usermenu purple pull-right">
                        ...
                        <li>
                            ...
                            <a href="/session/toLoginOut"><i class="fa fa-sign-out pull-right"></i>退出</a>
                        </li>
                    </ul>
                </li>
                <li>
