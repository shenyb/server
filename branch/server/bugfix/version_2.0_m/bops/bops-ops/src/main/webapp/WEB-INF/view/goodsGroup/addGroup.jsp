                        ...
                        <div class="form-page-wrap">
                            <div class="data-page-inner">
					            ...
					            <div class="info-top">
				           		...
				           		<form id="addExpertclassify"  name="myForm" action="/goodsGroup/addGoods" method="POST"  class="form-horizontal">
									<table class="table table-bordered table-hover table-condensed table-responsive">											
											...
											<tr>
									        	<td><i class="fa fa-asterisk"></i>商品编码</td>
						                       <td colspan="">
						                    ...
						                    <tr>
						                        ...
						                        <td colspan="3">
						                        	<input type="text" name="groupName" id="addGroupName" required class="form-control"/>
                                                  </td> 						                                          
						                    </tr>
											...
											<tr>
						                        ...
						                        <td colspan="">
						                        <textarea name="groupBrief" id="introduct" required class="form-control" rows="3" cols="50"></textarea>
						                        </td> 						                                          
						                    </tr>
						                     <tr class="table-title">
									         	<td colspan="2">
										...
										<tr>
											...
											<input type="radio" checked="checked" name="ruleType" value="DISCOUNT" /> 折扣
                                    		  &nbsp;&nbsp;
                                      		<input type="radio"  name="ruleType" value="FIXEDPRICE" /> 一口价
										...
										<tr name="DISCOUNTTR">
		                                    ...
		                                    <div class="col-xs-1 enough">
		                                      ...
		                                      <input type="text" name="ruleOne" class="form-control" id="ruleOne"/><em class="cake">件</em>
		                                      </div>
		                                      
		                                      <div class="col-xs-2 small-group">
		                                      <input type="text" name="ruleOneDisc" class="form-control" id="ruleOneDisc"/><em class="cake">折</em>
		                                      </div>
		                                  ...
		                                  <tr name="DISCOUNTTR">
		                                    ...
		                                    <td>
		                                      ...
		                                      <div class="col-xs-2 small-group">
		                                      <input type="text" name="ruleTwo" class="form-control" id="ruleTwo"/><em class="cake">件</em>
		                                      </div>
		                                      <div class="col-xs-2 small-group">
		                                      <input type="text" name="ruleTwoDisc" class="form-control" id="ruleTwoDisc"/><em class="cake">折</em>
		                                      </div>
		                                    </td>
		                                  ...
		                                  <tr name="DISCOUNTTR">
		                                    ...
		                                    <td>
		                                      ...
		                                      <div class="col-xs-2 small-group">
		                                      <input type="text" name="ruleThree" class="form-control" id="ruleThree"/><em class="cake">件</em>
		                                      </div>
		                                      <div class="col-xs-2 small-group">
		                                      <input type="text" name="ruleThreeDisc" class="form-control" id="ruleThreeDisc"/><em class="cake">折</em>
		                                      </div>
		                                    </td>		                                   										
					                    ...
					                    <tr id="FIXEDPRICEDIV" style="display: none;">
		                                    ...
		                                    <div class="col-xs-2 small-group">
		                                      <input type="text" name="ruleFixed" class="form-control" id="ruleFixed"/>
		                                      <em class="cake">件</em>
		                                      </div>
		                                      <div class="col-xs-2 small-group">
		                                      <input type="text" name="ruleFixedPrice" class="form-control" id="ruleFixedPrice"/>
		                                      <em class="cake">元</em>
		                                      </div>
		                                    </td>		                                    
		                                </tr>
												...
												<div class="bops-pub-wrap-inner">
													...
													<div class="bops-pub-body">
														<div class="bops-pub-param-body">
															<form  id="addExpertclassify"  name="myForm" action="/goodsGroup/addGoods" method="POST" >
															 <div class="bops-pub-param-header">
																...
																<table class="bops-pub-param-table">
																	<tbody>
																	<tr>
																		<th style="vertical-align: top;font-weight:normal;"><i style="color:red;">* </i> 商品编码</th>
																		<td>
																			<textarea name="goodsCodes" id="addGoodsCodes" required="" rows="5" cols="100" required></textarea>
																...
																<table class="bops-pub-param-table">
																	...
																	<tr>
																		...
																		<td>
																			<input type="text" name="groupName" id="addGroupName" required/>
																		</td>
																	</tr>
																	<tr>
																	...
																	<tr>
																		...
																		<td>
																			<textarea name="groupBrief" id="introduct" required="" rows="3" cols="50"></textarea>
																		</td>
																	</tr>
																</tbody>
																</table>
															 ...
															 <table class="bops-pub-param-table">
																<tbody>
																	...
																	<tr name="DISCOUNTTR">
																		...
																		<td>
																			满 &nbsp;&nbsp;<input type="text" name="ruleOne" id="ruleOne"/>&nbsp;&nbsp;件&nbsp;&nbsp;<input type="text" name="ruleOneDisc" id="ruleOneDisc"/>&nbsp;&nbsp;折
																		</td>
																		<td style="vertical-align: top;"></td>
																	</tr>
																	<tr name="DISCOUNTTR">
																		<th style="vertical-align: top;font-weight:normal;"></th>
																		<td>
																			满 &nbsp;&nbsp;<input type="text" name="ruleTwo" id="ruleTwo"/>&nbsp;&nbsp;件&nbsp;&nbsp;<input type="text" name="ruleTwoDisc" id="ruleTwoDisc"/>&nbsp;&nbsp;折
																		</td>
																		<td style="vertical-align: top;"></td>
																	</tr>
																	<tr name="DISCOUNTTR">
																		<th style="vertical-align: top;font-weight:normal;"></th>
																		<td>
																			满 &nbsp;&nbsp;<input type="text" name="ruleThree" id="ruleThree"/>&nbsp;&nbsp;件&nbsp;&nbsp;<input type="text" name="ruleThreeDisc" id="ruleThreeDisc"/>&nbsp;&nbsp;折
																		</td>
																		<td style="vertical-align: top;"></td>
																	</tr>
																	 ...
																	 <tr id="FIXEDPRICEDIV" style="display: none;">
																		<th style="vertical-align: top;font-weight:normal;"></th>
																		<td>
																			满 &nbsp;&nbsp;<input type="text" name="ruleFixed" id="ruleFixed"/>&nbsp;&nbsp;件&nbsp;&nbsp;<input type="text" name="ruleFixedPrice" id="ruleFixedPrice"/>&nbsp;&nbsp;元
																		</td>
																		<td style="vertical-align: top;"></td>
																	 </tr>
           ...
           if(ruleType=='DISCOUNT'){
        	  if(ruleOne==null||ruleOne==''||ruleTwo==null||ruleTwo==''||ruleThree==null||ruleThree==''||ruleOneDisc==null||ruleOneDisc==''||ruleTwoDisc==''||ruleTwoDisc==null||ruleThreeDisc==null||ruleThreeDisc==''){
        		...
        		return false;
        		 ...
        		 alert("件数请输入整形");
        		 return false;  
        	  }else if(!isPInt(ruleOneDisc)||!isPInt(ruleTwoDisc)||!isPInt(ruleThreeDisc)){
        		 alert("折扣格式有误");
         		 return false;         		  
