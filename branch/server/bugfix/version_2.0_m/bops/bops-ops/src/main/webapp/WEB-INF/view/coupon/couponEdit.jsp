				           		...
				           		<form id="couponForm" class="form-horizontal">
									<table class="table table-bordered table-hover table-condensed table-responsive">											
											<tr>
									            <td>优惠券编号</td>
						                       <td>
						                       		<input name="couponTemplateId" v value="${coupon.couponTemplateId}" type="hidden">
						                    ...
						                    <tr>
						                        ...
						                        <td colspan="3" class="large-group">
						                        		<select class="form-control" name="couponType" id="couponType" value="${coupon.couponType}">
											...
											<tr>
									            <td>指定商品sku</td>
						                        <td colspan="3"><input type="text" class="form-control" name="goodsSku" value="${coupon.goodsSku}" ></td> 						                                          
						                    </tr>
						                    <tr>
									            <td>有效时间(精确到秒)</td>
						                        <td colspan="3">
						                        	<div class="col-xs-5">
						                        	<b>开始时间</b><input type="text" id="startTimeString" name="startTimeString" class="form-control" 
                                                               value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:ss' value='${coupon.startTime}' type='both' />" onfocus="WdatePicker({firstDayOfWeek:1,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
                                                   </div>
                                                   <div class="col-xs-5">
                                                   <b>结束时间</b><input type="text" id="endTimeString" name="endTimeString" class="form-control" 
                                                           value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:ss' value='${coupon.endTime}' type='both' />" onfocus="WdatePicker({firstDayOfWeek:1,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
						                       		</div>
						                        </td>						                                          
						                    </tr>
						               <tr>
											...
											<td id="couponPicDiv">
												<input id="couponPicInput" name="couponPicKey" value="${coupon.couponPicKey}" type="hidden">
                                                       ...
                                                       <input id="couponPicUpload" name="files" data-url="/publicImageUpload" type="file" multiple style="display:${couponPicUploadDisplay}">
											</td>
											<td>券模板失效图片</td>
											<td id="disabledPicDiv">
												<input id="disabledPicInput" name="disabledPicKey" value="${coupon.disabledPicKey}" type="hidden">
                                                  ...
                                                  <input id="disabledPicUpload" name="files" data-url="/publicImageUpload" type="file" multiple style="display:${disabledPicUploadDisplay}">
											</td>									
										</tr>	
										<tr>
											<td>优惠券介绍</td>
					                    ...
					                    <tr>
								            <td>使用规则描述</td>
					                        <td colspan="3">
					                        	<textarea class="form-control" name="couponRule" rows="3">${coupon.couponRule}</textarea>
					                        </td>						                                          
					                    </tr>
					                    <tr>
								            <td>分享推荐语</td>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-9">
                                                                ...
                                                                <input type="text" id="endTimeString" name="endTimeString"
                                                                       placeholder="结束时间" value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:ss' value='${coupon.endTime}' type='both' />" onfocus="WdatePicker({firstDayOfWeek:1,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
