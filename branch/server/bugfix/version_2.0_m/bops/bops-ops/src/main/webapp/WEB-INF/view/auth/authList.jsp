...
<html>
    ...
    <body>
				        ...
				        <div class="info">
				            <div class="info-top">
				                ...
				                <div class="back">
				                    ...
				                    <a class="button button-rounded button-tiny" href="javascript:;" onclick="add()">新增</a>			                   
				                </div>
				            </div>
        ...
        <div class="modal fade" id="authOperateDiv" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                  ...
                  <input id="authId" value="" type="hidden">
                    ...
                    <div class="control-group">	                        
                          <label class="control-label col-lg-4" for=""> 权限CODE</label>                              
                          <div class="controls col-lg-5">	                                
                          	 <input type="text" id="authCode" value="" class="form-control">
                          </div>
                          <div style="clear: both;"></div>
                    </div>
                 
                     <div class="control-group">	                            
                           <label class="control-label col-lg-4" for=""> 权限名称</label>                              
                           <div class="controls col-lg-5">	                                
                           	 <input type="text" id="authName" value="" class="form-control">
                           </div>
                           <div style="clear: both;"></div>
                     </div>
                     <div class="control-group">	                             
                            <label class="control-label col-lg-4" for=""> 权限方法</label>                              
                            <div class="controls col-lg-5">	                                
                            	 <input type="text" id="authScope" value="" class="form-control" >
                            </div>
                            <div style="clear: both;"></div>
                      </div>
                   
                    <div class="control-group">	                              
                            <label class="control-label col-lg-4" for=""> 所属模块</label>                              
                            <div class="controls col-lg-5">	                                
                            	
                     			<input type="text" id="moduleName" value="" class="form-control">
                            </div>
                            <div style="clear: both;"></div>
                      </div>
                      <div class="control-group">	                             
                            <label class="control-label col-lg-4" for=""> 权限描述</label>                              
                            <div class="controls col-lg-5">	                                
                            	  
                    				 <input type="text" id="authDesc" value="" class="form-control">
                            </div>
                            <div style="clear: both;"></div>
                      </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" id="submitButton" onclick="submit();" class="button button-capitalize button-rounded button-primary button-small">
                            确定
                        </button>
                        <button type="button" aria-hidden="true" data-dismiss="modal" class="button button-capitalize button-rounded button-primary button-small">
                            取消
                        </button>
                    </div>
                  <!-- </form> -->
