					        ...
					        <div class="info">
					            <div class="info-top">
					                ...
					                <div class="back">
					                    ...
					                    <a class="button button-primary button-raised button-small" href="javascript:;" onclick="add()">新增</a>
					                </div>
					            </div>
					            ...
					            <table class="table table-bordered table-hover">					
					                ...
					                <c:forEach items="${list}" var="auth" varStatus="status">
										<tr>
											...
											<td><fmt:formatDate value="${auth.createTime}"
													type="both" /></td>
											<td><a id="${auth.authId}" href="javascript:;"
												onclick="view('${auth.authId}', '${auth.authCode}', 
                                                                       '${auth.authName}', '${auth.authScope}', '${auth.moduleName}', 
                                                                       '${auth.authDesc}')">查看</a>
												| <a id="${auth.authId}" href="javascript:;"
												onclick="update('${auth.authId}', '${auth.authCode}', '${auth.authName}', '${auth.authScope}', 
                                                                           '${auth.moduleName}', '${auth.authDesc}', '${auth.createTime}')">修改</a>
												| <a id="${auth.authId}" href="javascript:;"
												onclick="deleteById('${auth.authId}')">删除</a></td>
										</tr>
									</c:forEach>
					                </tbody>				            	
					            </table>
									...
									<div class="col-sm-12">
										<section class="panel">
											<header class="panel-heading ">
												...
												系统权限列表 <span class="tools pull-right"> <a
													class="ops-pub-btn" href=""> <i class="fa fa-refresh"></i>
														<span>刷新</span>
												</a> <a href="javascript:;" class="btn btn-info pull-right"
													onclick="add()">新增</a>
													...
													<thead>
														<tr role="row">
															<th
																...
																tabindex="0" class="sorting_asc">权限码</th>
															<th
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="authTitle">新增权限</h4>
				</div>
				<input id="authId" value="" type="hidden"> <input
					id="createTime" value="" type="hidden">
				<div style="margin: 10px 0px 10px 0px;">
					权限CODE: <input type="text" id="authCode" value="">
				</div>
				<div style="margin: 10px 0px 10px 0px;">
					权限名称: <input type="text" id="authName" value="">
				</div>
				<div style="margin: 10px 0px 10px 0px;">
					权限方法: <input type="text" id="authScope" value="">
				</div>
				<div style="margin: 10px 0px 10px 0px;">
					所属模块: <input type="text" id="moduleName" value="">
				</div>
				<div style="margin: 10px 0px 10px 0px;">
					权限描述: <input type="text" id="authDesc" value="">
				</div>
				<div class="modal-footer">
					<button type="button" id="submitButton" onclick="submit();"
