					        ...
					        <div class="info">
					            <div class="info-top">
					                ...
					                <div class="back">
					                    ...
					                    <a class="button button-primary button-raised button-small" href="/role/todetail">新增</a>
					                </div>
					            </div>
									...
									<div class="col-sm-12">
										<section class="panel">
											<header class="panel-heading ">
												...
												角色列表 <span class="tools pull-right"> <a
													class="ops-pub-btn" href=""> <i class="fa fa-refresh"></i>
														<span>刷新</span>
												</a> <a class="bops-pub-btn ng-isolate-scope"
													href="/role/todetail"><i class="fa fa-plus"></i><span>新增用户</span></a>
												</span>
											</header>
											<div
													...
													<thead>
														<tr role="row">
															<th
																...
																tabindex="0" class="sorting_asc">角色ID</th>
															<th
														...
														<c:forEach items="${list}" var="role" varStatus="status">
															<tr>
																...
																<td><fmt:formatDate value="${role.createTime}"
																		type="both" /></td>
																<td><a id="${role.roleId}"
																	href="/role/detail/page/${role.roleId}">查看 |</a> <a
																	id="${role.roleId}"
																	href="/role/detail/put/${role.roleId}">修改 |</a> <a
																	id="${role.roleId}" href="javascript:;"
																	onclick="deleteById('${role.roleId}')">删除</a></td>
															</tr>
														</c:forEach>
													</tbody>
												</table>
