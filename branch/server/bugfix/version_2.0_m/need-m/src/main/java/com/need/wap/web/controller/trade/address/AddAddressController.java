...
public class AddAddressController {
	...
	public Message addAddress_V1_3(@RequestBody AddressParamVO addressParamVO) {
		...
		if (!StringUtil.isBlank(addressParamVO.getCertificationCard())) {
			...
			Message result = tradeBaseService.certificationCardVerify(addressParamVO.getReceiver(),addressParamVO.getCertificationCard(), addressParamVO.getUserId(),addressParamVO.getCertificationChannel());
