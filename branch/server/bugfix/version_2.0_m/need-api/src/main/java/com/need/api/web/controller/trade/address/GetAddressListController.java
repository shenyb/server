...
public class GetAddressListController {
	...
	public Message getAddressList(
		...
		Page<AddressResultVO> page = (Page<AddressResultVO>) tradeAddressService.queryAddressList(userId);
	...
	@ResponseBody
	@RequestMapping(method = RequestMethod.GET, params = "apiVersion=1.3")
