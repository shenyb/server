...
//import com.need.api.common.alipay.util.AlipayNotify;
//import com.need.api.constant.ControllerMappings;
//import com.need.api.service.trade.TradeManager;
//import com.need.api.web.vo.trade.RefundNotifyVO;
//
///**
// * 
// * <p>
...
//
//	private static final Logger logger = Logger.getLogger(RefundNotifyController.class);
//	/**
//	 * @throws Exception @author shenyb 2015年8月5日 下午10:19:13 @Method:
//	 * refundNotify @return @throws
//	 */
//	@Autowired
...
//		}
//		logger.info("params:%%%%%%%%%%%%%%%%%%%%%%%" + JSONArray.toJSONString(params));
