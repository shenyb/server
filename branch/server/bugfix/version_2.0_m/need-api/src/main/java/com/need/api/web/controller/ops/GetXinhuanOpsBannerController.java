 ...
 */
@Controller
@RequestMapping(value = ControllerMappings.XINHUAN_BANNER_OPS)
public class GetXinhuanOpsBannerController {
	@Autowired
	private  OpsPositionService opsPositionService;
	
	@ResponseBody
	@RequestMapping(params = "apiVersion=1.3", method = RequestMethod.GET)
	public Message getXinhuanBannerOps_v1_3(){
		 Message success= opsPositionService.queryXinhuanOps_v1_3();
		  return success;
