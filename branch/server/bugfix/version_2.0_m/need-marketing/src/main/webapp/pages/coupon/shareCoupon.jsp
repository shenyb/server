...
<html lang="zh-cmn-Hans">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/need-marketing/app/css/reset.css">
        <link rel="stylesheet" type="text/css" href="/need-marketing/app/css/coupons_v0.1.1.css">
        <script src="/need-marketing/app/script/baiduStatistics.js" type="text/javascript"></script>
        <script src="/need-marketing/app/script/jquery.js" type="text/javascript"></script>
    </head>

    <body>
        <div class="container">
            <header class="header">
                <img src="/need-marketing/app/images/coupon/share_coupon_640x680.jpg" alt="">
                <div class="coupons-detail">
                    <img src="/need-marketing/app/images/coupon/share_conpon_detail_640x261.png" alt="">
                    <h2>
                        <p>${value}元</p>
                        <span>生活费</span>
                    </h2>
                ...
                <div class="coupons-quilt">
                    <img src="/need-marketing/app/images/coupon/share_coupon_quilt_640x299.png" alt="">
                </div>
            </header>
            <div class="content">
                <section class="des" style="display:${receive};">
                    <section class="inpt">
                        <form action="/need-marketing/coupon/login" method="get">
                            <p>
            ...
            $(function (){
                ...
                $('#submitButton').click(function (){
                    ...
                    if(mobile.length <= 8) {
                        ...
                        $.ajax({
                            type: "GET",
                            url: "/need-marketing/coupon/login",
