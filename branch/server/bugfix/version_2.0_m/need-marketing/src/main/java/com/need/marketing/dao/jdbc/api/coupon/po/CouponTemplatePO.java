...
public class CouponTemplatePO implements Serializable {
    ...
    public String toString() {
        return "CouponTemplatePO{" + "couponTemplateId=" + couponTemplateId + ", couponTemplateNo=" + couponTemplateNo + ", couponName=" + couponName + 
                ...
                ", maxReceiveCount=" + maxReceiveCount + ", goodsCategoryIds=" + goodsCategoryIds + ", channelIds=" + channelIds + ", couponType=" + couponType + 
                ", couponStatus=" + couponStatus + ", couponRule=" + couponRule + ", couponRecommend=" + couponRecommend + ", couponShareTitle=" + couponShareTitle + '}';
    }
